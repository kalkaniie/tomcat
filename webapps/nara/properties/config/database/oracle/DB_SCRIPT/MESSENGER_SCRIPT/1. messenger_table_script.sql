-----------------------------------------------------------
-- Export file for user KEBIMSG                          --
-- Created by Administrator on 2009-05-14, 오전 10:37:38 --
-----------------------------------------------------------

spool kebimsg_object_200902.log

prompt
prompt Creating table MSG_BANNER_INFO
prompt ==============================
prompt
create table MSG_BANNER_INFO
(
...
comment on column MSG_BANNER_INFO.B_SEQ_NO
  is '파일번호';
comment on column MSG_BANNER_INFO.ORGN_FILE_NM
  is '파일명';
comment on column MSG_BANNER_INFO.SERV_FILE_NM
  is '서버에저장된파일명';
comment on column MSG_BANNER_INFO.SERV_FILE_PATH
  is '서버에저장된경로';
comment on column MSG_BANNER_INFO.FILE_SIZE
  is '파일사이즈';
comment on column MSG_BANNER_INFO.LINK_URL
  is '링크주소';
comment on column MSG_BANNER_INFO.REG_DT
  is '등록일';
comment on column MSG_BANNER_INFO.BANNER_NM
  is '배너이름';
comment on column MSG_BANNER_INFO.B_USER_TYPE
  is '배너타입(0-고객용, 1-직원용)';
alter table MSG_BANNER_INFO
...
comment on column MSG_BATCH_ITEM.ITEM_CD
  is '배치코드';
comment on column MSG_BATCH_ITEM.ITEM_NM
  is '배치명';
comment on column MSG_BATCH_ITEM.ITEM_MASS
  is '배치방법';
comment on column MSG_BATCH_ITEM.ITEM_MACHINE
  is '배치실행서버';
comment on column MSG_BATCH_ITEM.ITEM_TERM
  is '배치주기';
...
create index IX_MSG_BATCH_LOG on MSG_BATCH_LOG (START_TIME)
  tablespace KP2_DATA
  pctfree 10
  initrans 2
  maxtrans 255
...
comment on column MSG_BUDDY_GROUP.GROUP_IDX
  is '그룹번호';
comment on column MSG_BUDDY_GROUP.GROUP_NAME
  is '그룹명';
comment on column MSG_BUDDY_GROUP.ISEDITABLE
  is '수정가능여부';
comment on column MSG_BUDDY_GROUP.ISDEFAULT
  is '디폴트여부';
comment on column MSG_BUDDY_GROUP.USERS_ID
  is '사용자계정(사번)';
comment on column MSG_BUDDY_GROUP.DOMAIN
  is '도메인';
comment on column MSG_BUDDY_GROUP.ETC
  is '기타';
alter table MSG_BUDDY_GROUP
...
create index IX1_MSG_BUDDY_GROUP on MSG_BUDDY_GROUP (USERS_ID, DOMAIN)
  tablespace KP2_DATA
  pctfree 10
  initrans 2
  maxtrans 255
...
comment on column MSG_BUDDY_LIST.BUDDY_IDX
  is '버디번호';
comment on column MSG_BUDDY_LIST.GROUP_IDX
  is '그룹번호';
comment on column MSG_BUDDY_LIST.BUDDY_ID
  is '버디계정(사번)';
comment on column MSG_BUDDY_LIST.BUDDY_DOMAIN
  is '버디도메인';
comment on column MSG_BUDDY_LIST.OWNER_ID
  is '버디소유자계정';
comment on column MSG_BUDDY_LIST.OWNER_DOMAIN
  is '버디소유자도메인';
comment on column MSG_BUDDY_LIST.ISBLOCKED
  is '차단여부(Y:차단, N:정상)';
comment on column MSG_BUDDY_LIST.BUDDYMEMO
  is '버디메모';
comment on column MSG_BUDDY_LIST.BUDDY_STATUS
  is '버디상태(0:알수없음.1:승인신청발신, 2:승인신청수신, 3:승인 -1:거절, -2:거절및 차단  -3:삭제, -4:삭제및 차단 -5:차단)';
alter table MSG_BUDDY_LIST
...
create index IX1_MSG_BUDDY_LIST on MSG_BUDDY_LIST (GROUP_IDX)
  tablespace KP2_DATA
  pctfree 10
  initrans 2
  maxtrans 255
...
create index IX2_MSG_BUDDY_LIST on MSG_BUDDY_LIST (OWNER_ID, OWNER_DOMAIN)
  tablespace KP2_DATA
  pctfree 10
  initrans 2
  maxtrans 255
...
create index IX3_MSG_BUDDY_LIST on MSG_BUDDY_LIST (BUDDY_ID, BUDDY_DOMAIN)
  tablespace KP2_DATA
  pctfree 10
  initrans 2
  maxtrans 255
...
prompt ======================================
prompt
create table MSG_BUDDY_LIST_DEL_BACK
(
  BUDDY_IDX    NUMBER not null,
  GROUP_IDX    NUMBER not null,
  BUDDY_ID     VARCHAR2(30) not null,
...
prompt ================================
prompt
create table MSG_BUDDY_REQ_MSG
(
  BUDDY_IDX  NUMBER not null,
  MSG        VARCHAR2(300),
...
comment on column MSG_CHAT_CHNL.CHNL_ROOM_MAX_CNT
  is '채널의 채팅방 Max Count';
comment on column MSG_CHAT_CHNL.CHNL_ROOM_USER_CNT
  is '채팅방의 사용자 Max Count';
alter table MSG_CHAT_CHNL
...
comment on column MSG_DOMAIN.DOMAIN
  is '도메인';
comment on column MSG_DOMAIN.DOMAINTYPE
  is '사용자타입(1:개인(기업)고객,
3:기업형고객 ,
4:호스팅고객)';
comment on column MSG_DOMAIN.DOMANISERVICESTATUS
  is '도메인상태
(0:사용정지
1:사용중 2:사용대기)';
comment on column MSG_DOMAIN.NOTE_TERM
  is '쪽지 보관일(일수)';
comment on column MSG_DOMAIN.ATTCH_FILE_SIZE
  is '첨부파일전송제한사이즈(Kbytes)';
comment on column MSG_DOMAIN.FILEROOM_SIZE
  is '파일방 파일 보관 제한사이즈(Kbytes)';
alter table MSG_DOMAIN
...
comment on column MSG_EXT_NOTEINFO.SEQ_NO
  is '외부메세지일련번호';
comment on column MSG_EXT_NOTEINFO.RECV_USER_KEY
  is '수신자주민번호';
comment on column MSG_EXT_NOTEINFO.MSG_TYPE
  is '메세지종류
001:입출금내역';
comment on column MSG_EXT_NOTEINFO.CNTNT
  is '내용';
comment on column MSG_EXT_NOTEINFO.RECV_DT
  is '접수일시';
comment on column MSG_EXT_NOTEINFO.SEND_YN
  is '전송여부';
comment on column MSG_EXT_NOTEINFO.SEND_DT
  is '전송일시';
comment on column MSG_EXT_NOTEINFO.NOTE_IDX
  is '쪽지테이블pk';
...
comment on column MSG_FILEROOM_DIR.DIR_SEQ_NO
  is '디렉토리번호';
comment on column MSG_FILEROOM_DIR.DIR_NM
  is '디렉토리명';
comment on column MSG_FILEROOM_DIR.DOMAIN
  is '도메인';
comment on column MSG_FILEROOM_DIR.USERS_ID
  is '사용자계정(사번)';
comment on column MSG_FILEROOM_DIR.PRNT_DIR_SEQ_NO
  is '부모디렉토리번호';
alter table MSG_FILEROOM_DIR
...
create index IX1_MSG_FILEROOM_DIR on MSG_FILEROOM_DIR (USERS_ID, DOMAIN)
  tablespace KP2_DATA
  pctfree 10
  initrans 2
  maxtrans 255
...
create index IX2_MSG_FILEROOM_DIR on MSG_FILEROOM_DIR (USERS_ID, DOMAIN, DIR_SEQ_NO)
  tablespace KP2_DATA
  pctfree 10
  initrans 2
  maxtrans 255
...
prompt ================================
prompt
create table MSG_FILEROOM_FILE
(
...
comment on column MSG_FILEROOM_FILE.F_SEQ_NO
  is '파일번호';
comment on column MSG_FILEROOM_FILE.DIR_SEQ_NO
  is '디렉토리번호';
comment on column MSG_FILEROOM_FILE.USERS_ID
  is '사용자계정(사번)';
comment on column MSG_FILEROOM_FILE.DOMAIN
  is '도메인';
comment on column MSG_FILEROOM_FILE.ORGN_FILE_NM
  is '파일명';
comment on column MSG_FILEROOM_FILE.SERV_FILE_NM
  is '서버에저장된파일명';
comment on column MSG_FILEROOM_FILE.SERV_FILE_PATH
  is '서버에저장된경로';
comment on column MSG_FILEROOM_FILE.FILE_SIZE
  is '파일사이지';
comment on column MSG_FILEROOM_FILE.REG_DT
  is '등록일';
alter table MSG_FILEROOM_FILE
...
alter table MSG_FILEROOM_FILE
  ...
  references MSG_FILEROOM_DIR (DIR_SEQ_NO) on delete cascade;
create index IX1_MSG_FILEROOM_FILE on MSG_FILEROOM_FILE (DIR_SEQ_NO)
  tablespace KP2_DATA
  pctfree 10
  initrans 2
  maxtrans 255
...
create index IX2_MSG_FILEROOM_FILE on MSG_FILEROOM_FILE (USERS_ID, DOMAIN)
  tablespace KP2_DATA
  pctfree 10
  initrans 2
  maxtrans 255
...
prompt =====================================
prompt
create table MSG_FILEROOM_PSN_SHARE
(
  DIR_SEQ_NO NUMBER not null,
  DOMAIN     VARCHAR2(20) not null,
  USERS_ID   VARCHAR2(30) not null,
...
comment on column MSG_FILEROOM_PSN_SHARE.DIR_SEQ_NO
  is '디렉토리번호';
comment on column MSG_FILEROOM_PSN_SHARE.PMSN
  is 'A(모든권한)R(읽기)W(쓰기)';
alter table MSG_FILEROOM_PSN_SHARE
...
comment on column MSG_FRBD_WORD.SEQ_NO
  is '금칙어번호';
comment on column MSG_FRBD_WORD.KEYWORD
  is '금칙어';
comment on column MSG_FRBD_WORD.DOMAIN
...
comment on column MSG_LOGIN_HSTR.GUBUN
  is 'L-login R-register';
comment on column MSG_LOGIN_HSTR.USER_TYPE
  is '사용자타입
(1:일반_개인고객,
2:일반_기업고객,
3:기업은행직원,
...
comment on column MSG_MENU_INFO.MENU_ID
  is '메뉴ID';
comment on column MSG_MENU_INFO.MENU_NM
  is '메뉴명';
alter table MSG_MENU_INFO
...
prompt ===================================
prompt
create table MSG_MENU_INFO_DOMAIN
(
  MENU_ID VARCHAR2(20) not null,
  DOMAIN  VARCHAR2(20) not null
)
...
comment on column MSG_MENU_INFO_DOMAIN.MENU_ID
  is '메뉴ID';
comment on column MSG_MENU_INFO_DOMAIN.DOMAIN
  is '도메인';
alter table MSG_MENU_INFO_DOMAIN
...
comment on column MSG_NOTEFILE.FILE_IDX
  is '파일일련번호';
comment on column MSG_NOTEFILE.FILENAME
  is '파일명';
comment on column MSG_NOTEFILE.SERVER_FILEPATH
  is '서버에저장된파일명';
comment on column MSG_NOTEFILE.LOCAL_FILEPATH
  is '로컬파일경로';
comment on column MSG_NOTEFILE.FILESIZE
  is '파일사이즈';
comment on column MSG_NOTEFILE.FILE_SERVER_IP
  is '파일서버IP';
comment on column MSG_NOTEFILE.FILE_SERVER_PORT
  is '파일서버PORT';
comment on column MSG_NOTEFILE.FILE_DEL_DT
  is '파일삭제예정일';
alter table MSG_NOTEFILE
...
prompt
prompt Creating table MSG_NOTEFILE_0809
prompt ================================
prompt
create table MSG_NOTEFILE_0809
(
  FILE_IDX         NUMBER not null,
  FILENAME         VARCHAR2(128) not null,
  SERVER_FILEPATH  VARCHAR2(128) not null,
...
prompt
prompt Creating table MSG_NOTEFILE_0810
prompt ================================
prompt
create table MSG_NOTEFILE_0810
(
  FILE_IDX         NUMBER not null,
  FILENAME         VARCHAR2(128) not null,
  SERVER_FILEPATH  VARCHAR2(128) not null,
...
comment on column MSG_NOTEINFO.NOTE_IDX
  is '쪽지일련번호';
comment on column MSG_NOTEINFO.SND_USERS_ID
  is '송신자계정(사번)';
comment on column MSG_NOTEINFO.SND_DOMAIN
  is '송신자도메인';
comment on column MSG_NOTEINFO.SND_USER_NM
  is '송신자명';
comment on column MSG_NOTEINFO.NOTE_CONTENTS
  is '쪽지내용';
comment on column MSG_NOTEINFO.NOTE_FONT
  is '쪽지폰트';
comment on column MSG_NOTEINFO.MSG_TYPE
  is '(메시지구분
(C01 - 일반 대화,
...
SMS200 - 문자대화송신,
SMS300 - 문자대화수신)';
comment on column MSG_NOTEINFO.GROUPID
  is '버디그룹번호';
comment on column MSG_NOTEINFO.SEND_DT
  is '발송일시';
comment on column MSG_NOTEINFO.SECU_TIME
  is '보안시간';
comment on column MSG_NOTEINFO.NOTE_DEL_DT
  is '쪽지삭제예정일';
comment on column MSG_NOTEINFO.FILE_YN
  is '첨부파일유무';
comment on column MSG_NOTEINFO.MSG_GROUP
  is '쪽지 구분 (0:쪽지, 1:대화)';
comment on column MSG_NOTEINFO.BG_IMG_IDX
  is '쪽지의 바탕 이미지 Index';
comment on column MSG_NOTEINFO.CLIENT_NOTE_IDX
  is '사용자의 쪽지 저장 Index';
alter table MSG_NOTEINFO
...
create index IX1_MSG_NOTEINFO on MSG_NOTEINFO (SEND_DT)
  tablespace KP2_DATA
  pctfree 10
  initrans 2
  maxtrans 255
...
prompt
prompt Creating table MSG_NOTEINFO_0809
prompt ================================
prompt
create table MSG_NOTEINFO_0809
(
  NOTE_IDX      NUMBER not null,
  SND_USERS_ID  VARCHAR2(30) not null,
  SND_DOMAIN    VARCHAR2(20) not null,
...
prompt
prompt Creating table MSG_NOTEINFO_0810
prompt ================================
prompt
create table MSG_NOTEINFO_0810
(
  NOTE_IDX      NUMBER not null,
  SND_USERS_ID  VARCHAR2(30) not null,
  SND_DOMAIN    VARCHAR2(20) not null,
...
prompt ================================
prompt
create table MSG_NOTEINFO_FILE
(
  NOTE_IDX     NUMBER not null,
  FILE_IDX     NUMBER not null,
...
comment on column MSG_NOTEINFO_FILE.NOTE_IDX
  is '쪽지일련번호';
comment on column MSG_NOTEINFO_FILE.FILE_IDX
  is '파일일련번호';
comment on column MSG_NOTEINFO_FILE.FILE_RECV_YN
  is '파일수신여부';
alter table MSG_NOTEINFO_FILE
...
prompt
prompt Creating table MSG_NOTEINFO_FILE_0809
prompt =====================================
prompt
create table MSG_NOTEINFO_FILE_0809
(
  NOTE_IDX     NUMBER not null,
  FILE_IDX     NUMBER not null,
  FILE_RECV_YN CHAR(1)
...
prompt
prompt Creating table MSG_NOTEINFO_FILE_0810
prompt =====================================
prompt
create table MSG_NOTEINFO_FILE_0810
(
  NOTE_IDX     NUMBER not null,
  FILE_IDX     NUMBER not null,
  FILE_RECV_YN CHAR(1)
...
comment on column MSG_NOTE_RECVERS.NOTE_RECV_IDX
  is '일련번호';
comment on column MSG_NOTE_RECVERS.NOTE_IDX
  is '메세지일련변호';
comment on column MSG_NOTE_RECVERS.RECV_USERS_ID
  is '수신자아이디';
comment on column MSG_NOTE_RECVERS.RECV_DOMAIN
  is '수신자도메인';
comment on column MSG_NOTE_RECVERS.RECV_USER_NM
  is '수신자이름';
comment on column MSG_NOTE_RECVERS.RECV_CONFIRM_YN
  is '수신확인체크여부';
comment on column MSG_NOTE_RECVERS.RECV_YN
  is '수신자수신여부';
comment on column MSG_NOTE_RECVERS.RECV_DT
  is '수신자_수신일시';
alter table MSG_NOTE_RECVERS
...
create index IX1_MSG_NOTE_RECVERS on MSG_NOTE_RECVERS (NOTE_IDX)
  tablespace KP2_DATA
  pctfree 10
  initrans 2
  maxtrans 255
...
create index IX2_MSG_NOTE_RECVERS on MSG_NOTE_RECVERS (RECV_USERS_ID, RECV_DOMAIN, NOTE_RECV_IDX)
  tablespace KP2_DATA
  pctfree 10
  initrans 2
  maxtrans 255
...
prompt
prompt Creating table MSG_NOTE_RECVERS_0809
prompt ====================================
prompt
create table MSG_NOTE_RECVERS_0809
(
  NOTE_RECV_IDX   NUMBER not null,
  NOTE_IDX        NUMBER not null,
  RECV_USERS_ID   VARCHAR2(30) not null,
...
prompt
prompt Creating table MSG_NOTE_RECVERS_0810
prompt ====================================
prompt
create table MSG_NOTE_RECVERS_0810
(
  NOTE_RECV_IDX   NUMBER not null,
  NOTE_IDX        NUMBER not null,
  RECV_USERS_ID   VARCHAR2(30) not null,
...
comment on column MSG_SERVERLIST.STATUS
  is '''0'':데몬비활성화, ''1'':데몬활성화';
comment on column MSG_SERVERLIST.KIND
...
prompt ==================================
prompt
create table MSG_STAFF_DEPT_INFO
(
...
comment on column MSG_STAFF_DEPT_INFO.ORG_CD
  is '부서코드';
comment on column MSG_STAFF_DEPT_INFO.PRNT_ORG_CD
  is '상위부서코드';
comment on column MSG_STAFF_DEPT_INFO.ORG_NM
  is '부서명';
alter table MSG_STAFF_DEPT_INFO
...
create index IX1_MSG_DEPT_INFO on MSG_STAFF_DEPT_INFO (PRNT_ORG_CD)
  tablespace KP2_DATA
  pctfree 10
  initrans 2
  maxtrans 255
...
prompt
prompt Creating table MSG_STAFF_DEPT_INFO_BAK
prompt ======================================
prompt
create table MSG_STAFF_DEPT_INFO_BAK
(
  ORG_CD      VARCHAR2(10) not null,
  PRNT_ORG_CD VARCHAR2(10) not null,
  ORG_NM      VARCHAR2(100),
...
comment on column MSG_STAFF_INFO.USERS_ID
  is '사용자계정(사번)';
comment on column MSG_STAFF_INFO.DOMAIN
  is '도메인';
comment on column MSG_STAFF_INFO.ORG_CD
  is '부서코드';
comment on column MSG_STAFF_INFO.SORT_NO
  is '소팅순서';
comment on column MSG_STAFF_INFO.ABRV_POSI_NM
  is '직위명';
comment on column MSG_STAFF_INFO.LVL
  is '직급명';
comment on column MSG_STAFF_INFO.CORP_TENO
  is '사내전화';
comment on column MSG_STAFF_INFO.HM_TENO
  is '집전화';
comment on column MSG_STAFF_INFO.FAX_NO
  is '팩스번호';
comment on column MSG_STAFF_INFO.TEAM_NM
  is '팀명';
comment on column MSG_STAFF_INFO.DUCD
  is '직책코드';
comment on column MSG_STAFF_INFO.POSI_CD
  is '직위코드';
comment on column MSG_STAFF_INFO.JOIN_YMD
  is '입사일';
comment on column MSG_STAFF_INFO.RMK
  is '비고';
alter table MSG_STAFF_INFO
...
create index IX1_MSG_STAFF_INFO on MSG_STAFF_INFO (ORG_CD, SORT_NO)
  tablespace KP2_DATA
  pctfree 10
  initrans 2
  maxtrans 255
...
prompt
prompt Creating table MSG_STAFF_INFO_BAK
prompt =================================
prompt
create table MSG_STAFF_INFO_BAK
(
  USERS_ID     VARCHAR2(30) not null,
  DOMAIN       VARCHAR2(20) not null,
  ORG_CD       VARCHAR2(10) not null,
...
prompt ================================
prompt
create table MSG_STAFF_ORG_FAV
(
  USERS_ID VARCHAR2(30) not null,
  DOMAIN   VARCHAR2(20) not null,
...
comment on column MSG_STAFF_ORG_FAV.USERS_ID
  is '사용자계정(사번)';
comment on column MSG_STAFF_ORG_FAV.DOMAIN
  is '도메인';
comment on column MSG_STAFF_ORG_FAV.ORG_CD
  is '부서코드';
comment on column MSG_STAFF_ORG_FAV.SEQ_NO
  is '일련번호';
alter table MSG_STAFF_ORG_FAV
...
create index UK1_MSG_STAFF_ORG_FAV on MSG_STAFF_ORG_FAV (USERS_ID, DOMAIN, ORG_CD)
  tablespace KP2_DATA
  pctfree 10
  initrans 2
  maxtrans 255
...
prompt ======================================
prompt
create table MSG_STATISTICS_YYYYMMDD
(
  YYYYMMDD          VARCHAR2(8),
...
comment on column MSG_USER_INFO.USERS_ID
  is '사용자계정(사번)';
comment on column MSG_USER_INFO.DOMAIN
  is '도메인';
comment on column MSG_USER_INFO.DISPLAYNAME
  is '대화명';
comment on column MSG_USER_INFO.USERCURRENTSTATUS
  is '메신저사용상태';
comment on column MSG_USER_INFO.USER_LOCAL_IP
  is '접속한사용자IP';
comment on column MSG_USER_INFO.USER_LOCAL_PORT
  is '접속한사용자PORT';
comment on column MSG_USER_INFO.SERVER_IP
  is '접속된서버IP';
comment on column MSG_USER_INFO.SERVER_PORT
  is '접속된서버PORT';
comment on column MSG_USER_INFO.CLIENT_TYPE
  is '접속매체(W:웹, A:어플리케이션)';
comment on column MSG_USER_INFO.PWDFAIL_COUNT
  is '암호입력 실패 Count';
alter table MSG_USER_INFO
...
create index IX1_MSG_USER_INFO on MSG_USER_INFO (SERVER_IP, SERVER_PORT)
  tablespace KP2_DATA
  pctfree 10
  initrans 2
  maxtrans 255
...
comment on column MSG_USER_MASTER.USERS_ID
  is '사용자계정(사번)';
comment on column MSG_USER_MASTER.DOMAIN
  is '도메인';
comment on column MSG_USER_MASTER.USER_NM
  is '이름';
comment on column MSG_USER_MASTER.RSN_NO
  is '주민(사업자등록)번호';
comment on column MSG_USER_MASTER.PASSWD
  is '비밀번호';
comment on column MSG_USER_MASTER.USER_TYPE
  is '사용자타입
(1:일반_개인고객,
2:일반_기업고객,
3:기업고객,
4:호스팅고객)';
comment on column MSG_USER_MASTER.MOBILE_PHONE
  is '핸드폰번호';
comment on column MSG_USER_MASTER.PASSWORD_QST
  is '비밀번호질문';
comment on column MSG_USER_MASTER.PASSWORD_ASW
  is '비밀번호답';
comment on column MSG_USER_MASTER.VALID_YN
  is '인증회원여부(Y:공인인증 N:실명인증)';
comment on column MSG_USER_MASTER.SMS_QT
  is 'sms발송가능수량(9999:발송제한없음.)';
comment on column MSG_USER_MASTER.USER_LVL
  is '사용자레벨(
0:사용정지,
1:일반회원
2:도메인관리자
3:시스템관리자,9:암호입력오류횟수초과정지)';
alter table MSG_USER_MASTER
...
create index IX1_MSG_USER_MASTER on MSG_USER_MASTER (DOMAIN)
  tablespace KP2_DATA
  pctfree 10
  initrans 2
  maxtrans 255
...
create index IX2_MSG_USER_MASTER on MSG_USER_MASTER (RSN_NO, USER_TYPE)
  tablespace KP2_DATA
  pctfree 10
  initrans 2
  maxtrans 255
...
create index IX3_MSG_USER_MASTER on MSG_USER_MASTER (USER_NM)
  tablespace KP2_DATA
  pctfree 10
  initrans 2
  maxtrans 255
...
create index IX4_MSG_USER_MASTER on MSG_USER_MASTER (USERS_ID, DOMAIN, USER_NM)
  tablespace KP2_DATA
  pctfree 10
  initrans 2
  maxtrans 255
...
prompt ========================================
prompt
create table MSG_USER_MASTER_DEL_USERS
(
  USERS_ID     VARCHAR2(30) not null,
  DOMAIN       VARCHAR2(20) not null,
  USER_NM      VARCHAR2(30) not null,
...
comment on column MSG_WEATHER_AREA.AREA_CD
  is '지역코드';
comment on column MSG_WEATHER_AREA.AREA_NM
  is '지역명';
alter table MSG_WEATHER_AREA
...
prompt ===================================
prompt
create table MSG_WEATHER_FORECAST
(
  SEQ_NO                 NUMBER not null,
  WORK_DT                VARCHAR2(8),
  WORK_TM                VARCHAR2(8),
...
comment on column MSG_WEATHER_FORECAST.SEQ_NO
  is '일련번호';
comment on column MSG_WEATHER_FORECAST.WORK_DT
  is '발표일자';
comment on column MSG_WEATHER_FORECAST.WORK_TM
  is '발표시각';
comment on column MSG_WEATHER_FORECAST.TDY_MIN_TMPR
  is '오늘최저온도';
comment on column MSG_WEATHER_FORECAST.TMRW_MIN_TMPR
  is '내일최저온도';
comment on column MSG_WEATHER_FORECAST.AFTR_TMRW_MIN_TMPR
  is '모레최저온도';
comment on column MSG_WEATHER_FORECAST.TDY_MAX_TMPR
  is '오늘최고온도';
comment on column MSG_WEATHER_FORECAST.TMRW_MAX_TMPR
  is '내일최고온도';
comment on column MSG_WEATHER_FORECAST.AFTR_TMRW_MAX_TMPR
  is '모레최고온도';
comment on column MSG_WEATHER_FORECAST.TDY_CD
  is '오늘날씨코드';
comment on column MSG_WEATHER_FORECAST.TMRW_CD
  is '내일날씨코드';
comment on column MSG_WEATHER_FORECAST.AFTR_TMRW_CD
  is '모레날씨코드';
comment on column MSG_WEATHER_FORECAST.TDY_DETAIL
  is '오늘날씨상세';
comment on column MSG_WEATHER_FORECAST.TMRW_DETAIL
  is '내일날씨상세';
comment on column MSG_WEATHER_FORECAST.AFTR_TMRW_DETAIL
  is '모레날씨상세';
comment on column MSG_WEATHER_FORECAST.TDY_AM_RAIN_PRBL
  is '오늘오전강수확률';
comment on column MSG_WEATHER_FORECAST.TMRW_AM_RAIN_PRBL
  is '내일오전강수확률';
comment on column MSG_WEATHER_FORECAST.AFTR_TMRW_AM_RAIN_PRBL
  is '모레오전강수확률';
comment on column MSG_WEATHER_FORECAST.TDY_PM_RAIN_PRBL
  is '오늘오후강수확률';
comment on column MSG_WEATHER_FORECAST.TMRW_PM_RAIN_PRBL
  is '내일오후강수확률';
comment on column MSG_WEATHER_FORECAST.AFTR_TMRW_PM_RAIN_PRBL
  is '모레오후강수확률';
comment on column MSG_WEATHER_FORECAST.AREA_CD
  is '지역코드';
alter table MSG_WEATHER_FORECAST
...
prompt ===================================
prompt
create table MSG_WEATHER_REALTIME
(
  SEQ_NO  NUMBER not null,
  WORK_DT VARCHAR2(8),
  WORK_TM VARCHAR2(8),
...
comment on column MSG_WEATHER_REALTIME.SEQ_NO
  is '일련번호';
comment on column MSG_WEATHER_REALTIME.WORK_DT
  is '발표일자';
comment on column MSG_WEATHER_REALTIME.WORK_TM
  is '발표일시';
comment on column MSG_WEATHER_REALTIME.TMPR
  is '온도';
comment on column MSG_WEATHER_REALTIME.AREA_CD
  is '지역코드';
alter table MSG_WEATHER_REALTIME
...
create index IX1_MSG_WEATHER_REALTIME on MSG_WEATHER_REALTIME (AREA_CD, SEQ_NO)
  tablespace KP2_DATA
  pctfree 10
  initrans 2
  maxtrans 255
...
create index IX1_TEMP_STAFF_INFO on TEMP_STAFF_INFO (ORG_CD)
  tablespace KP2_DATA
  pctfree 10
  initrans 2
  maxtrans 255
...
prompt =====================================
prompt
create sequence SEQ_MSG_BANNER_INFO
minvalue 1
...
prompt ===================================
prompt
create sequence SEQ_MSG_BATCH_LOG
minvalue 1
...
prompt =====================================
prompt
create sequence SEQ_MSG_BUDDY_GROUP
minvalue 1
maxvalue 999999999999999999
start with 31283
increment by 1
...
prompt ====================================
prompt
create sequence SEQ_MSG_BUDDY_LIST
minvalue 1
maxvalue 999999999999999999
start with 483971
increment by 1
...
prompt ===================================
prompt
create sequence SEQ_MSG_CHAT_CHNL
minvalue 1
...
prompt ======================================
prompt
create sequence SEQ_MSG_EXT_NOTEINFO
minvalue 1
maxvalue 999999999999999999
start with 34182
increment by 1
...
prompt ======================================
prompt
create sequence SEQ_MSG_FILEROOM_DIR
minvalue 1
maxvalue 99999999999999999999
start with 571
increment by 1
...
prompt =======================================
prompt
create sequence SEQ_MSG_FILEROOM_FILE
minvalue 1
maxvalue 99999999999999999999
start with 1076
increment by 1
...
prompt ==================================
prompt
create sequence SEQ_MSG_NOTEFILE
minvalue 1
maxvalue 999999999999999999999999999
start with 550
increment by 1
...
prompt ==================================
prompt
create sequence SEQ_MSG_NOTEINFO
minvalue 0
maxvalue 999999999999999999999999999
start with 46402
increment by 1
...
prompt ===================================
prompt
create sequence SEQ_MSG_NOTE_RECV
minvalue 1
...
prompt =====================================
prompt
create sequence SEQ_NOTEINFORMATION
minvalue 1
maxvalue 99999999999999999999
start with 21
increment by 1
...
prompt ======================================
prompt
create sequence SEQ_TB_IBK_DEPT_INFO
minvalue 1
maxvalue 999999999999999999
start with 239
increment by 1
...
prompt =========================================
prompt
create sequence SEQ_TB_WEATHER_FORECAST
minvalue 1
...
prompt =========================================
prompt
create sequence SEQ_TB_WEATHER_REALTIME
minvalue 1
maxvalue 999999999999999999
start with 90361
increment by 1
...
prompt ===============================
prompt
create or replace package PKG_ADMIN_INFO is
...
prompt ==============================
prompt
create or replace package PKG_BATCH_LOG is
...
prompt ==================================
prompt
create or replace package PKG_FILEROOM_INFO is
...
prompt ==============================
prompt
create or replace package PKG_MSG_BUDDY is
...
prompt =============================
prompt
create or replace package PKG_MSG_CHAT is
...
prompt =============================
prompt
create or replace package PKG_MSG_JOIN is
...
prompt ==============================
prompt
create or replace package pkg_msg_login is
...
prompt ================================
prompt
create or replace package PKG_MSG_MESSAGE is
...
prompt ====================================
prompt
create or replace package PKG_MSG_SERVER_INFO is
...
prompt ===============================
prompt
create or replace package PKG_MSG_STATUS is
...
prompt ===================================
prompt
create or replace package PKG_STAFF_ORG_INFO is
...
prompt ==========================
prompt
create or replace type ListItemType AS TABLE OF varchar2(32767)
/
...
prompt =========================
prompt
create or replace function IN_LIST(p_str IN NVARCHAR2) Return ListItemType AS
...
prompt ================================
prompt
CREATE OR REPLACE FUNCTION SF_GET_USER_NM(p_domainname in varchar2, p_userid in varchar2) RETURN VARCHAR2 IS
/******************************************************************************
   NAME:       SF_GET_USER_NM
...
prompt =================================
prompt
create or replace procedure SP_BACKUP_NOTE is
c_i number;
c_x number;
v_sql varchar2(300);
...
prompt ================================
prompt
create or replace procedure SP_DATA_CLEAN is
...
prompt ===================================
prompt
create or replace procedure SP_INS_BATCH_LOG(p_item_cd in varchar2, p_result_cd in varchar2,
...
prompt ====================================
prompt
create or replace procedure SP_LOAD_DEPT_INFO(p_dept_file_line number) is
c_i number;
c_x number;
v_sql varchar2(300);
v_cnt number;
...
prompt ===================================
prompt
create or replace procedure SP_LOAD_EMP_INFO(p_emp_file_line number) is
c_i number;
c_x number;
v_sql varchar2(300);
v_cnt number;
...
prompt ===============================
prompt
create or replace procedure sp_set_admin is
begin
...
prompt ====================================
prompt
create or replace package body PKG_ADMIN_INFO is
...
prompt ===================================
prompt
create or replace package body PKG_BATCH_LOG is
...
prompt =======================================
prompt
create or replace package body PKG_FILEROOM_INFO is
...
prompt ===================================
prompt
create or replace package body PKG_MSG_BUDDY is
...
prompt ==================================
prompt
create or replace package body PKG_MSG_CHAT is
...
prompt ==================================
prompt
create or replace package body PKG_MSG_JOIN is
...
prompt ===================================
prompt
create or replace package body pkg_msg_login is
...
prompt =====================================
prompt
create or replace package body PKG_MSG_MESSAGE is
...
prompt =========================================
prompt
create or replace package body PKG_MSG_SERVER_INFO is
...
prompt ====================================
prompt
create or replace package body PKG_MSG_STATUS is
...
prompt ========================================
prompt
create or replace package body PKG_STAFF_ORG_INFO is

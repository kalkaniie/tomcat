...
<script type="text/javascript" src="/js/kor/usergroup/usergroup_pop3.js"></script>
	...
	<tr>
		<td width="195" style="padding-right: 5px">
		  <div class="k_puHeadC3">
            ...
            <a href="#" style="width:28%;margin-right:4px" onClick="makeAddressStr('usergroup2.auth.do?method=usergroup_list_pop&objForm=<%=objForm%>')" ><span>직급</span></a>
            <a href="#" style="width:28%;" class="k_puHeadC3_on" onClick="makeAddressStr('usergroup3.auth.do?method=usergroup_list_pop&objForm=<%=objForm%>')"><span>직위</span></a>
          </div>

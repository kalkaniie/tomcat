...
<!--
function userSearch(){
	var objForm = document.user_temp_list;
  	...
  	objForm.method.value = "uesr_temp_info_list";
...
function download() {
	var objForm = document.user_temp_list;
	objForm.action = "user.admin.do";
	objForm.method.value = "aj_user_temp_list_download";
	//objForm.submit();
	objForm.submit();
}
...
<form name="user_temp_list" method="post">
<input type=hidden name='method' value='uesr_temp_info_list'> 
...
<div class="k_puAdmin">
  <ul class="k_tab_menu">
	...
	<li class="k_tab_menuOn"><b><a href="user.admin.do?method=uesr_temp_info_list" >가입대기</a></b></li>
	<li><a href="user.admin.do?method=uesr_staff_info_list" >직원정보</a></li>
...
<div class="k_tab_boxTop"><img src="/images/kor/tabmenu/admin_tabTopL.gif" class="k_fltL" /><img src="/images/kor/tabmenu/admin_tabTopR.gif" class="k_fltR" /></div>
  <div class="k_tab_boxMid">
    <table class="k_tb_other4">
	  <tr>
		<!--<th width="20" scope="col"><img src="/images/kor/ico/ico_check.gif" width="13" height="13" onClick="checkAll(document.user_temp_list, 'USERS_IDX')" ;/></th>-->
		<th scope="col">이름</th>
		<th width="150" scope="col">사번</th>
		<th width="150" scope="col">소속</th>
		<th width="150" scope="col">직위</th>
		<th width="150" scope="col">내선번호</th>
	  </tr>
<%
	if (list == null) {
%>
...
%>
	  <tr>
		<%--<td><input type="checkbox" name="USERS_IDX" value="<%=userEntity.USERS_LICENCENUM%>" /></td>--%>
		<td class="k_txAliC"><%=userEntity.USERS_NAME%></td>
		<td class="k_txAliC"><%=userEntity.USERS_LICENCENUM%></td>
		<td class="k_txAliC"><%=userEntity.USERS_DEPARTMENT == null ? "" : userEntity.USERS_DEPARTMENT%></td>
		<td class="k_txAliC"><%=userEntity.USERS_COMPNAME == null ? "" : userEntity.USERS_COMPNAME%></td>
		<td class="k_txAliC"><%=userEntity.USERS_INSIDETELNO == null ? "" : userEntity.USERS_INSIDETELNO%></td>
	  </tr>
<%
			}
		}
...
<script language=javascript>
	setSelectedIndexByValue( document.user_temp_list.strIndex, "<%=strIndex%>" );
	setCheckBoxByValue( document.user_temp_list.inResearch, "<%=inResearch%>" );
</script>

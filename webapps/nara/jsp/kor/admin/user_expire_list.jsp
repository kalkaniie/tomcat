...
<!--
function userSearch(){
	var objForm = document.user_expire_list;
  	...
  	objForm.method.value = "uesr_expire_info_list";
...
function download() {
	var objForm = document.user_expire_list;
	objForm.action = "user.admin.do";
	objForm.method.value = "aj_user_expire_list_download";
	//objForm.submit();
	objForm.submit();
}
...
<form name="user_expire_list" method="post">
<input type=hidden name='method' value='uesr_expire_info_list'> 
...
<div class="k_puAdmin">
  <ul class="k_tab_menu">
	...
	<li class="k_tab_menuOn"><b><a href="user.admin.do?method=uesr_expire_info_list" >퇴직직원정보</a></b></li>
</ul>
<div class="k_tab_boxTop"><img src="/images/kor/tabmenu/admin_tabTopL.gif" class="k_fltL" /><img src="/images/kor/tabmenu/admin_tabTopR.gif" class="k_fltR" /></div>
  <div class="k_tab_boxMid">
    <table class="k_tb_other4">
	  <tr>
		<!--<th width="20" scope="col"><img src="/images/kor/ico/ico_check.gif" width="13" height="13" onClick="checkAll(document.user_expire_list, 'USERS_ID')" ;/></th>-->
		<th scope="col">아이디</th>
		<th width="120" scope="col">이름</th>
		<th width="120" scope="col">소속</th>
		<th width="120" scope="col">직위</th>
		<th width="120" scope="col">휴대폰</th>
		<th width="120" scope="col">퇴직일</th>
	  </tr>
<%
	if (list == null) {
%>
...
%>
	  <tr>
		...
		<td class="k_txAliC"><%=tempMap.get("USERS_EXPIREDDATE2")%></td>
	  </tr>
<%
			}
		}
...
<script language=javascript>
	setSelectedIndexByValue( document.user_expire_list.strIndex, "<%=strIndex%>" );
	setCheckBoxByValue( document.user_expire_list.inResearch, "<%=inResearch%>" );
</script>

    ...
    var oP = getById('suggestKeyword','parent');
        ...
        //alert("c"+str+ "d"); 
			...
			//alert(Op2);
			//alert(tMenuName);
			var sList = "<br><table cellpadding=0 cellspacing=0 border=0 width=100%>";
	    	...
	    	//tMenuName = tMenuName.replace('&gt;', '>');
				sList += "<tr style='cursor:hand;font-family:dotum,돋움,gulim;font-size:9pt;color:#6A6A6A;' id='menu"+i+"' onmouseover=mOverColor('menu"+i+"',"+i+") onClick=mSelected('"+ i +"'); ><td height='19' style='padding-left:2px;'>" + chWord(Op2,tMenuName) + "</td></tr>";
	...
	top.document.forms['search'].requery.onkeyup = function(e) {
	          ...
	          tMenuName = rMenu[nCurMenu-1];		
				...
				try
				{
			    	...
			    	} else
			    	{
						...
						//top.document.forms['search'].requery.value = tMenuName;

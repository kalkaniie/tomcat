...
<%
	...
	int nMaxAttache = conf.getInt("com.nara.kebimail.attache.max.mbox");
...
//	long nPerFileSize = Long.parseLong((String)session.getAttribute("DOMAIN_LIMIT_UPLOAD"))*1024*1024;
	...
	//long nPerFileSize = 50*1024*1024;
	long nPerFileSize = conf.getLong("com.nara.kebimail.maxsize.mbox")*1024*1024;

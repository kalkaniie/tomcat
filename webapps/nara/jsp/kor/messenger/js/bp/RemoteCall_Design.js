...
function acceptRemoteCall(user_id ,user_nm ,szRoomID ,szFlag ,szView ,szOption ,szDisplayID ,szSendID ,szSendNAME){
		try{
			...
			{		
					...
					if(szFlag == 1){
						tmpszFlag = "2"; 
					}else if(szFlag ==2 || szFlag ==3){
						tmpszFlag = "1";
					}
					//alert(tmpszFlag);
					//ifmKebiRemoteCaller.KebiRemoteCaller.RemoteCall("1",szFlag,szSendID,szSendNAME,user_id,szDisplayID);
					ifmKebiRemoteCaller.KebiRemoteCaller.RemoteCall("1",tmpszFlag,szSendID,szSendNAME,user_id,szDisplayID);

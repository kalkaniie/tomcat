...
//		             bbar: [new Ext.Button(action2)],
		...
		mboxnWinM.on('close', serverClose);
		mboxnWinM.show();	
...
function buddyTreeEditYn(el,groupNm, before)
{
    ...
    //alert("1111" + n.attributes.text);
      //var temp = before.split("(");
      var temp = n.attributes.text.split("(");
      
      //buddyTreeEditor.startEdit(el, temp[0]);
      //tree.setDisabled(true);
      tree.suspendEvents();
      buddyTreeEditor.setValue(temp[0]);
      //buddyTreeEditor.setValue("ddd");
} 

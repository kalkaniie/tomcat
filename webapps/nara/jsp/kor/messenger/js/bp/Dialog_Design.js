...
var dialogueWindow = {
  ...
  create: function(dialogueID, buddyName, buddyID, state) {
        ...
        var webEditorButtonHtml = " <img src='/jsp/kor/messenger/images/ico/icon_btn01_off.gif' id='bold_"+dialogueID+"' class='msgWdw_edit_icon' align='absmiddle' onclick=\"CtntEditor.toggleBold('"+dialogueID+"');\"> "+
                             " <img src='/jsp/kor/messenger/images/ico/icon_btn02_off.gif' id='italic_"+dialogueID+"' class='msgWdw_edit_icon' align='absmiddle' onclick=\"CtntEditor.toggleItalic('"+dialogueID+"');\"> "+
                             " <img src='/jsp/kor/messenger/images/ico/icon_btn03_off.gif' id='underline_"+dialogueID+"' class='msgWdw_edit_icon' align='absmiddle' onclick=\"CtntEditor.toggleUnderline('"+dialogueID+"');\"> "+
                             " <img src='/jsp/kor/messenger/images/ico/icon_btn04_off.gif' id='fontColor_"+dialogueID+"' class='msgWdw_edit_icon' align='absmiddle' onclick=\"CtntEditor.toggleFontColor('"+dialogueID+"');\"><div id='msgFontColor_"+dialogueID+"'></div> ";
        var webEditorHtml = " <table height='30' width='100%' border='0' cellspacing='1' cellpadding='0' bgcolor='#D7D7D7'><tr><td bgcolor='#E7E7E7'>"+ fontNameSelectHtml + fontSizeSelectHtml + webEditorButtonHtml +"</td></tr></table>"
...
//        var titleHtml = '<table cellpadding="0" cellpading="0" border="0" width="85%"><tr><td width="75%"><b>'+ buddyName + '님과대화</b> </td><td aling="right"><div id="track1'+dialogueID+'" style="width:70px; height:1px; height:2px; cursor:hand; align:right;"><img src="" width="1" height="8"><br><img src="/images/default/grid/grid3-special-col-bg.gif" width="70" height="2" align="absmiddle"></div>'+
//                        '<img src="/jsp/kor/messenger/images/default/grid/sort_asc.gif" id="handle1'+dialogueID+'" style="cursor:hand;"></td></tr></table>';
 		 var titleHtml = '<table cellpadding="0" cellspacing="0" border="0" width="85%"><tr><td width="85%"><img src="/jsp/kor/realtime/images/ico/icon_admin.gif"><b>'+ buddyName + '</b>님과  대화</td>'+
        ...
        ({
            ...
            handler: function()
            {  
                if(invtDialogArr.indexOf(dialogueID) == -1) {
...
//        });
        ...
        ({
            ...
            //text: '초대하기',
            text: '원격제어 요청',
            iconCls: 'callRemoteImg',
            handler: function()
            {  
            	activeXinstallWindow.create(buddyID);
            }
        });
...
//        });        
        ...
        ({
            ...
            {  
                //hidef.js_saveMsg(dialogueID);
            	Note_popup = true;
                //js_Note_open(dialogueID);
                js_Note_open(buddyID, buddyName,dialogueID);
                //clickBuddyId ,clickBuddyNm ,szIndex
            }
        });  
...
{	
	...
	var win = window.open('/jsp/kor/messenger/dialogue.jsp?dlid='+ dialogueID +'&bn='+ buddyName +'&bid='+buddyID, 'dialogue_'+dialogueID+'_'+rlSendID[0], 'toolbar=no,location=no,directories=no,status=no,menubar=no,scrollbars=no, resizable=yes,copyhistory=no,width=400, height=500, left=100,top=100');	
	win.focus();
...
var CtntEditor = {
    ...
    toggleBold: function(dialogueID) {
        ...
        if(sendTextarea.style.fontWeight == '700') {
            $('bold_'+dialogueID).src = '/jsp/kor/messenger/images/ico/icon_btn01_off.gif';
            sendTextarea.style.fontWeight = '400';
        } else {
            $('bold_'+dialogueID).src = '/jsp/kor/messenger/images/ico/icon_btn01_over.gif';
    ...
    toggleItalic: function(dialogueID) {
        ...
        if(sendTextarea.style.fontStyle == 'italic') {
            ...
            $('italic_'+dialogueID).src = '/jsp/kor/messenger/images/ico/icon_btn02_off.gif';
            sendTextarea.style.fontStyle = 'normal';
             
        } else {
            $('italic_'+dialogueID).src = '/jsp/kor/messenger/images/ico/icon_btn02_over.gif';
    ...
    toggleUnderline: function(dialogueID) {
        ...
        if(sendTextarea.style.textDecoration == 'underline') {
            ...
            $('underline_'+dialogueID).src = '/jsp/kor/messenger/images/ico/icon_btn03_off.gif';
            sendTextarea.style.textDecoration = 'none';

             
        } else {
            $('underline_'+dialogueID).src = '/jsp/kor/messenger/images/ico/icon_btn03_over.gif';
    ...
    toggleFontColor: function(dialogueID) {
        ...
        if(ftb.style.display == 'block') {
            $('fontColor_'+dialogueID).src = '/jsp/kor/messenger/images/ico/icon_btn04_off.gif';
            ftb.style.display= 'none';
               
        } else {
            $('fontColor_'+dialogueID).src = '/jsp/kor/messenger/images/ico/icon_btn04_over.gif';
            ftb.style.left= 160;
            ftb.style.top= 25;
		...
		if(room_id == -1){  //설치 안되었을 경우
		   ...
		   var window = new Ext.Window({
		       ...
		       buttons: [{
		            text: '확인',
		             handler: function(){
		             	ifmKebiRemoteCaller.location.href =	"/jsp/kor/messenger/activeX/KebiRemoteCaller.exe";
			...
			// alert(hidef.user_id +":"+hidef.user_nm+":"+buddyID+":"+room_id+":"+buddyID);
			if(Ext.get('remoteCaller_loading')!= null){
        		Ext.get('remoteCaller_loading').show();
        		setPanelXY($(remoteCaller_loading));
			}
			hidef.RcsInviteReq(hidef.user_id,hidef.user_nm, buddyID,  room_id ,buddyID );
		}  
    }    

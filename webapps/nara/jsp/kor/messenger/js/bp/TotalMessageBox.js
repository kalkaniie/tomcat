  ...
  create: function( mode , snd_rcv_flag , user_id ,iddomain ) {
    ...
    var ds = new Ext.data.Store({
        proxy: new Ext.data.HttpProxy({
            //url: 'http://210.116.116.142/jsp/kor/messenger/note_execute.jsp'
            url: 'http://' + hidef.ServerDomain + '/jsp/kor/messenger/note_execute.jsp'
        }),
...
function noteGridClick( noteGridPanel )
{
    ...
    var recv_yn       = (record.getSelected().get( 'recv_yn')=='Y')?'읽음' :'안읽음';
...
function setNoteDetailData(flag, recv_yn , recv_user_nm , recv_dt, snd_user_nm , send_dt , note_contents , file_yn, file_count, file_info)
{
    ...
    note_contents = replaceAll(note_contents,"" ,"</br>");
...
function setNoteDetailFileName(fileInfo , fileCount)
{
    ...
    if( fileInfo.length > 0 && fileCount > 0)
    {
        ...
        for( i = 0 ; i < fileCount ; i++)
        {
            ...
            fileHtml += '<img src="/jsp/kor/messenger/images/default/tree/leaf.gif" absmiddle>&nbsp;<a href="http://'+hidef.ServerDomain+'/messenger/notefiledwn?file1='+filewebpath+'&file2='+ fileOrgNm + '" target="hidef">'+fileNmSize+'</a><br>'   ;
        }

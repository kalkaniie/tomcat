    ...
    for(i=0; i<Record_arr.length-1; i++)
    {
    	...
    	if(Record_arr[i] != '')
    	{
            ...
            if(usertype == '1' || usertype == '2')
  				...
  				{
  					//alert(szRecord[8]+":::"+szRecord[9]+":::"+transCustomer(szRecord[0]));
                
                 // rslt[i] = [ szRecord[3], szRecord[2], transCustomer(szRecord[0]), szRecord[8], szRecord[9], szRecord[11], szRecord[12], szRecord[4] ];
				 rslt[i] = [ szRecord[3], szRecord[2], transCustomer(szRecord[0]), szRecord[9], '', szRecord[11], szRecord[12], szRecord[5] ];

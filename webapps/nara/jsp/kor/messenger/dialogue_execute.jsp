...
<%!
	public Connection getConnection()	throws Exception
	{
		try
		{
			...
			//return DriverManager.getConnection("jdbc:oracle:thin:@211.238.156.201:1521:kebi", "kebi", "kebi");
			return DriverManager.getConnection("jdbc:oracle:thin:@210.116.116.202:1521:kebi", "km5", "km5");
		} catch(Exception ex)
		{
			throw ex;
		}

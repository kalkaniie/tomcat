...
<script type="text/javascript" src="/js/kor/usergroup/usergroup_pop.js"></script>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0" style="margin-top:3px;">
	<tr>
		...
		<td><a href="javascript:makeAddressStr('usergroup.auth.do?method=usergroup_list_pop&objForm=<%=objForm%>')"><img src="/images_std/kor/btn/tab_add2_on.gif" /></a></td>
		<% } %>
...
<div class="k_fltL"><a href="javascript:;"
	...
	onClick="key_srch_addr('u');">U~Z</a></div></td>

...
<table border="0" cellpadding="0" cellspacing="0">
	<tr>
		<td class="admin_logo">
			<!-- <img src="/images_std/kor/set/logo.gif" style="margin-top:8px;" />-->
			<br/><br/><img src="/images_std/kor/set/title.gif" /></td>
		...
		<table border="0" cellpadding="0" cellspacing="0">
			<tr>
				...
				<td><img src="/images_std/kor/set/menu10.gif" /></td>
				<% } %>
				<td><a href="formletter.admin.do?method=formletter_list"><img src="/images_std/kor/set/menu4<%=onImg4%>.gif" border="0" /></a></td>

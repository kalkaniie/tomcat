...
//var server_ip = '211.238.156.201';
var server_ip = '210.116.116.202';
...
if( user_id != '' )
{
	...
	/*XML socket  /jsp/kor/realtime/common */
	//$('xmlsocket').innerHTML = flash_load('/js/common/socket_client.swf','0','0', server_ip, server_port);
	$('xmlsocket').innerHTML = flash_load('/jsp/kor/realtime/common/socket_client_utf8.swf','0','0', server_ip, server_port);
	//alert('here');

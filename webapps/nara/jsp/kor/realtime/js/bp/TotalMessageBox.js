  ...
  create: function( mode , snd_rcv_flag , user_id ,iddomain ) {
    ...
    var ds = new Ext.data.Store({
        proxy: new Ext.data.HttpProxy({
            //url: 'http://210.116.116.142/jsp/kor/realtime/note_execute.jsp'
            url: 'http://demo.kebi.com/jsp/kor/realtime/note_execute.jsp'
        }),
...
function setNoteDetailFileName(fileInfo , fileCount)
{
    ...
    if( fileInfo.length > 0 && fileCount > 0)
    {
        ...
        for( i = 0 ; i < fileCount ; i++)
        {
            ...
            fileHtml += '<img src="/jsp/kor/realtime/images/default/tree/leaf.gif" absmiddle>&nbsp;<a href="http://demo.kebi.com/realtime/notefiledwn?file1='+filewebpath+'&file2='+ fileOrgNm + '" target="hidef">'+fileNmSize+'</a><br>'   ;
        }

...
function RemoteCallRequest(szSendID ,szSendNAME ,szRoomID ,szFlag ,szView ,szOption ,szDisplayID)
{
	try{
		
		parent.RemoteCallDesignRequest(szSendID ,szSendNAME ,szRoomID ,szFlag ,szView ,szOption ,szDisplayID);

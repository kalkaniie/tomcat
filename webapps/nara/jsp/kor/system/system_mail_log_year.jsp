...
function downloadExcel() {
	var objForm = document.f;
	objForm.action = "maillog.system.do?method=downloadExcel&view=year";
	objForm.submit();
}
-->
</script>
...
<table cellspacing="0" class="tb_graph4">
	<tr>
<%
	for(int i=1; i<=12; i++) {
...
%>
		...
		<div class="graph11"><img src="/images/common/graph_dot01_9.gif" width="9" height="<%=outputPercentage(yCount,mle.MAIL_LOG_RECEIVE_COUNT)%>%" /></div>
		<div class="graph12"><img src="/images/common/graph_dot02_9.gif" width="9" height="<%=outputPercentage(yCount,mle.MAIL_LOG_SEND_COUNT)%>%" /></div>
		<div class="graph13"><img src="/images/common/graph_dot03_9.gif" width="9" height="<%=outputPercentage(yCount,mle.MAIL_LOG_ERROR_COUNT)%>%" /></div>
		</td>
<% } %>
	</tr>
</table>
<table cellspacing="1" class="tb_graphNo4">
	<tr>
<% for(int i=1; i<=12; i++) { %>
		<td><%=i%></td>
<% } %>

...
function downloadExcel() {
  var objForm = document.f;
  objForm.action = "maillog.system.do?method=downloadExcel&view=week";
  objForm.submit();
}
-->
</script>
...
<div class="k_puTit">
<h2 class="k_puTit_ico2">통계및로그 관리 <strong>메일송수신현황</strong></h2>
<hr />
</div>
<ul class="k_tip_ul">
...
<table>
	<tr>
		<td align="center">
			...
			<a href="javascript:Search();"><img src="/images/kor/btn/popup_search.gif" width="60" height="21" /></a>
...
<table cellspacing="0" class="tb_graph2">
	<tr>
<%
	for(int i=1; i<=7; i++) {
...
<table cellspacing="1" class="tb_graphNo2">
	<tr>
<% for(int i=1; i<=7; i++) { %>
		<td><%=i%></td>
<% } %>

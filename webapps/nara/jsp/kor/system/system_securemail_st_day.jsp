...
<div class="k_puTit">
<h2 class="k_puTit_ico2">시스템관리 <strong>보안메일송수신현황</strong></h2>
<hr />
</div>
<ul class="k_tip_ul">
	<li>보안메일송수신현황에서는 일별보기/주별보기/월별보기/년별보기가 가능합니다.</li>
</ul>
<div class="k_puAdmin_box" style="margin-top: 15px" style="table-layout:fixed">
...
<table cellspacing="1" class="sec_tb_graph">
	<tr>
<%
	for(int i=1; i<=24; i++) {
...
<table cellspacing="1" class="sec_tb_graphNo">
	<tr>
		<%
for(int i=1; i<=24; i++) {
%>

...
<table cellspacing="1" class="sec_tb_graph3">
	<tr>
		<%
...
%>
		...
		<%--<div class="graph11"><img src="/images/common/graph_dot01_5.gif" width="13" height="<%=outputPercentage(yCount,entity.TOT_SEND)%>%" /></div>
		<div class="graph12"><img src="/images/common/graph_dot02_5.gif" width="13" height="<%=outputPercentage(yCount,entity.TOT_RECEIVE)%>%" /></div>
		--%>
		<div class="graph13"><img src="/images/common/graph_dot03_5.gif" width="13" height="<%=outputPercentage(yCount,entity.TOT_SEND_NOMAL)%>%" /></div>
		<div class="graph13"><img src="/images/common/graph_dot04_5.gif" width="13" height="<%=outputPercentage(yCount,entity.TOT_RECEIVE_NOMAL)%>%" /></div>
		<div class="graph13"><img src="/images/common/graph_dot05_5.gif" width="13" height="<%=outputPercentage(yCount,entity.TOT_SEND_SECURE)%>%" /></div>
		<div class="graph13"><img src="/images/common/graph_dot06_5.gif" width="13" height="<%=outputPercentage(yCount,entity.TOT_RECEIVE_SECURE)%>%" /></div>
		</td>
		<%
}
%>
...
<table cellspacing="1" class="sec_tb_graphNo3">
	<tr>
		<%
for(int i=1; i<=5; i++) {
%>

function anaList(returnStr)   {
	...
	var currForm = eval("document.anaForm"+uniqStrThis);
...
function anaFrontList(){
	...
	var tempMail_seq     = currForm.mail_seq.value;
	var tempMailServletUrl = currForm.mailServletURL.value;
	var anaURL = tempSendURL + "/mail/anaconda.public.do?method=popupActiveX&USERS_IDX=" + tempUsers_idx + "&MAIL_SEQ=" + tempMail_seq;	
	var fileFrontList="";
  	...
  	fileFrontList +=  "<font size=2>대용량첨부파일</font><span style='position:absolute;right:5px;top:2px'><a href=\'" + anaURL + "' target='_new'><img src='" + tempSendURL + "/images/kor/btn/btnB_savePc.gif' border=0 /></a></span>";
  	fileFrontList +=  "</caption>";
  	fileFrontList +=  "<tr>";
  	fileFrontList +=  "<th style='background:#ececec url(" + tempSendURL + "/images/kor/line/2tonG_14px.gif) no-repeat left 2px; border-top:1px solid #fff; border-bottom:1px solid #cacaca; text-align: center; line-height: 19px; font-weight: normal;'><font size=2>파일명</font></th>";
  	fileFrontList +=  "<th width='74' style='background:#ececec url(" + tempSendURL + "/images/kor/line/2tonG_14px.gif) no-repeat left 2px; border-top:1px solid #fff; border-bottom:1px solid #cacaca; text-align: center; line-height: 19px; font-weight: normal;'><font size=2>형식</font></th>";
  	fileFrontList +=  "<th width='90' style='background:#ececec url(" + tempSendURL + "/images/kor/line/2tonG_14px.gif) no-repeat left 2px; border-top:1px solid #fff; border-bottom:1px solid #cacaca; text-align: center; line-height: 19px; font-weight: normal;'><font size=2>용량</font></th>";
  	fileFrontList +=  "<th width='150' style='background:#ececec url(" + tempSendURL + "/images/kor/line/2tonG_14px.gif) no-repeat left 2px; border-top:1px solid #fff; border-bottom:1px solid #cacaca; text-align: center; line-height: 19px; font-weight: normal;'><font size=2>다운로드기간</font></th>";
  	fileFrontList +=  "</tr>";

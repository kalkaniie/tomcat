function Folder(folderDescription, hreference, target, IDX) //constructor
{
  ...
  //dynamic data
  this.isOpen = true
  this.iconSrc = "../images/kor/users/tree/file_folderclosed.gif"
...
function propagateChangesInState(folder)
{
  ...
  if (folder.isOpen)
  {
    if (folder.nodeImg)
      if (folder.isLastNode)
        folder.nodeImg.src = "../images/kor/users/tree/file_mlastnode.gif"
      else
	  folder.nodeImg.src = "../images/kor/users/tree/file_mnode.gif"
    if(folder.absIconSrc == "" )
      folder.iconImg.src = "../images/kor/users/tree/file_folderopen.gif"
     else if(folder.absIconSrc == "../image/kor/users/tree/file_folderclosed.gif")
      folder.iconImg.src = "../images/kor/users/tree/file_folderopen.gif"
    else if(folder.absIconSrc == "../image/kor/users/tree/file_foldershare.gif")
      folder.iconImg.src = "../images/kor/users/tree/file_folderopenshare.gif"
    else
  ...
  else
  {
    if (folder.nodeImg)
      if (folder.isLastNode)
        folder.nodeImg.src = "../images/kor/users/tree/file_plastnode.gif"
      else
	    folder.nodeImg.src = "../images/kor/users/tree/file_pnode.gif"
    if(folder.absIconSrc == "")
      folder.iconImg.src = "../images/kor/users/tree/file_folderclosed.gif"
    else
      folder.iconImg.src = folder.absIconSrc
    for (i=0; i<folder.nChildren; i++)
...
var nc
  ...
  if (level>0)
    ...
    {
      this.renderOb(leftSide + auxEv + "<img name='nodeIcon" + this.id + "' src='../images/kor/users/tree/file_mlastnode.gif' border=0 align=absmiddle></a>")
      leftSide = leftSide + "<img src='../images/kor/users/tree/file_blank.gif' width=16 height=20>"
      this.isLastNode = 1
    }
    else
    {
      this.renderOb(leftSide + auxEv + "<img name='nodeIcon" + this.id + "' src='../images/kor/users/tree/file_mnode.gif' border=0 align=absmiddle></a>")
      leftSide = leftSide + "<img src='../images/kor/users/tree/file_vertline.gif'>"
      this.isLastNode = 0
    }
  else
  {

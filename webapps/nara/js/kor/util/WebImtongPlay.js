...
function WebImtongStart(MailToName, MailToIDX, MailFromName, MailFromIDX){
		...
		document.writeln("codebase='http://demo.kebiportal.com/nara/imtong/WebImTong.cab#version=3,1,0,1'>       ");
		...
		document.writeln("<PARAM NAME = 'IMBS' VALUE = '211.238.156.22:21001'>                             ");
		document.writeln("<PARAM NAME = 'FRS' VALUE = '211.238.156.22:21004'>                               ");
		document.writeln("<PARAM NAME = 'RCS' VALUE = '210.116.116.143:80'>                               ");
...
function WebImtongBase64(nsUserParam)
{
		...
		arrScript.push("codebase=\"http://demo.kebiportal.com/nara/imtong/WebImTong.cab#version=3,1,0,1\"> ");
		arrScript.push("<PARAM NAME = \"UserParam\" VALUE =\""+nsUserParam+"\" > ");
		arrScript.push("<PARAM NAME = \"IMBS\" VALUE = \"211.238.156.22:21001\"> ");
		arrScript.push("<PARAM NAME = \"FRS\" VALUE = \"211.238.156.22:21004\"> ");
		arrScript.push("<PARAM NAME = \"RCS\" VALUE = \"210.116.116.143:80\"> ");
		arrScript.push("<PARAM NAME = \"msgviewtype\" VALUE = \"CHAT\" > ");	

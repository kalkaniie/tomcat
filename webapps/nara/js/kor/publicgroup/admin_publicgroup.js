...
Ext.onReady(function(){
	...
	publicAddressDataStore = new Ext.data.Store({
     proxy: new Ext.data.HttpProxy({
     	url: 'publicaddress.admin.do?method=aj_publicaddress_list',
     	method: 'POST'
     }),
     baseParams: {		
     	//method: 'aj_publicaddress_list'
		PUBLICGROUP_IDX: document.f.PUBLICGROUP_IDX.value !="" ? document.f.PUBLICGROUP_IDX.value :1,
		strIndex : strIndex,
    ...
    publicAddressDataStore.on('beforeload', function() {
    	publicAddressDataStore.baseParams = { 
    	PUBLICGROUP_IDX: document.f.PUBLICGROUP_IDX.value !="" ? document.f.PUBLICGROUP_IDX.value :1,
  	    strIndex : strIndex,
       	strKeyword:document.f.strKeyword.value
  	  };

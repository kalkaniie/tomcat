DSR.MypageBbsKoreaMediaGridPlugin = Ext.extend(Ext.grid.GridPanel, {
	...
	initComponent : function() {
	   	...
	   	Ext.apply(this, {
			store : new Ext.data.Store({
				autoLoad:true,
		     	...
		     	baseParams:{method:"aj_get_board_list", USERS_LISTNUM:"7",BBS_IDX:2},
		     	//baseParams:{},
        ...
        DSR.MypageBbsKoreaMediaGridPlugin.superclass.initComponent.apply(this, arguments);
    },
...
Ext.reg('mypageKoreaMediaGrid', DSR.MypageBbsKoreaMediaGridPlugin);

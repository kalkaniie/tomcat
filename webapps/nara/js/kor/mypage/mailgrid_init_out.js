DSR.MypageMailGridPluginOut = Ext.extend(Ext.grid.GridPanel, {
	...
	initComponent : function() {
		...
		Ext.apply(this, {
			store : new Ext.data.Store({
				storeId :'mypage_outbox_store',
				autoLoad:true,
			 	proxy: new Ext.data.HttpProxy({
			 	url: 'webmail.auth.do',
			 		method: 'POST'
			 	}),
			 	baseParams:{method:'aj_mail_list_mypage',MBOX_TYPE:2, LISTNUM:'20'},
        ...
        DSR.MypageMailGridPluginOut.superclass.initComponent.apply(this, arguments);
...
Ext.reg('mypageMailGridOut', DSR.MypageMailGridPluginOut);
DSR.MypageBbsNewsLetterGridPlugin = Ext.extend(Ext.grid.GridPanel, {
	...
	initComponent : function() {
	   	...
	   	Ext.apply(this, {
			store : new Ext.data.Store({
				autoLoad:true,
		     	...
		     	baseParams:{method:"aj_mypage_newsletter_bbs_list", USERS_LISTNUM:"7",BBS_IDX:6},
		     	//baseParams:{},
        ...
        DSR.MypageBbsNewsLetterGridPlugin.superclass.initComponent.apply(this, arguments);
    },
...
Ext.reg('mypageNewsLetterGrid', DSR.MypageBbsNewsLetterGridPlugin);

...
address_list_space.address_list = function() {
    ...
    var colModel = new Ext.grid.ColumnModel([
 	...
 	function getUniqStr(){
 		return mainPanel.getActiveTab().getEl().child("form").dom.uniqStr.value;
 	}
		...
		if(listOrView =="view"){
			mainPanel.getActiveTab().body.load({
				...
				params:{
					...
					nPage:Ext.getCmp('maillist_bbar'+mainPanel.getActiveTab().getEl().child("form").dom.listDivRenderId.value).getPageData().activePage,
	...
	function goAddressAdd() { 
		  MM_openBrWindow('address.auth.do?method=address_add_pop_form&nMode=tab','_address','width=500,height=633');
	};
    ...
    return {
    	...
    	init : function() {
    		...
    		Ext.EventManager.onWindowResize(function(){gp_address_list.setWidth(getReturnWidth(20,100))}, this, false);

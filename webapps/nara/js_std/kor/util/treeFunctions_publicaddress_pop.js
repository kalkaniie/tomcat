function Folder(folderDescription, hreference, target, IDX) //constructor
{
  ...
  //dynamic data
  this.isOpen = true
  this.iconSrc = "../img/tree/file_folderclosed.gif"
...
var nc
  ...
  if (level>0)
    ...
    {
      this.renderOb(leftSide + auxEv + "<img name='nodeIcon" + this.id + "' src='../image/kor/file_mlastnode.gif' align=absmiddle border=0></a>")
      leftSide = leftSide + "<img src='../image/kor/file_blank.gif' width=16 height=20 align=absmiddle>"
      this.isLastNode = 1
    }
    else
    {
      this.renderOb(leftSide + auxEv + "<img name='nodeIcon" + this.id + "' src='../image/kor/file_mnode.gif' align=absmiddle border=0></a>")

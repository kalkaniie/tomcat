...
function printDateBrTimeSelect( selectName ) {
    ...
    var hourSelectName = selectName + '_hour';
    var minuteSelectName = selectName + '_minute';
    document.writeln( makeYearSelect( yearSelectName ) + '년 '+makeMonthSelect( monthSelectName) +'월 '+makeDateSelect( dateSelectName) +'일 '+"<br>"+makeHourSelect( hourSelectName) +'시 '+makeMinuteSelect( minuteSelectName) +'분 ');
}
...
function printDateBrTimeSelectSms( selectName ) {
    ...
    var hourSelectName = selectName + '_hour';
    var minuteSelectName = selectName + '_minute';
    returnVal+= makeYearSelect( yearSelectName ) + '년 '+makeMonthSelect( monthSelectName) +'월 '+makeDateSelect( dateSelectName) +'일 '+"<br>"+makeHourSelect( hourSelectName) +'시 '+makeMinuteSelect( minuteSelectName) +'분 ';
    return returnVal;    
}
...
function printDateToSecondSelect( selectName ) {
    ...
    document.writeln( makeYearSelect( yearSelectName ) + '년 '+makeMonthSelect( monthSelectName) +'월 '+makeDateSelect( dateSelectName) +'일 '+makeHourSelect( hourSelectName) +'시 '+makeMinuteSelect( minuteSelectName) +'분 '+makeSecondSelect( secondSelectName) +'초 ');
}
...
function printDateHourSelect2( selectName ) {
    ...
    var dateSelectName = selectName + '_date';
    var hourSelectName = selectName + '_hour';
    returnVal += makeYearSelect( yearSelectName ) + '년 '+makeMonthSelect( monthSelectName) +'월 '+makeDateSelect( dateSelectName) +'일 '+makeHourSelect( hourSelectName) +'시 ';
    return returnVal;     
}
...
function printDateHourSelect( selectName ) {
    ...
    var dateSelectName = selectName + '_date';
    var hourSelectName = selectName + '_hour';
    document.writeln( makeYearSelect( yearSelectName ) + '년 '+makeMonthSelect( monthSelectName) +'월 '+makeDateSelect( dateSelectName) +'일 '+makeHourSelect( hourSelectName) +'시 ');
}
/**
...
function printDateSelect( selectName ) {
    ...
    var monthSelectName	= selectName + '_month';
    var dateSelectName = selectName + '_date';
    document.writeln( makeYearSelect( yearSelectName ) + '년 '+makeMonthSelect( monthSelectName) +'월 '+makeDateSelect( dateSelectName) +'일 ');
}
...
function printMonthDateSelect( selectName ) {
    ...
    var monthSelectName	= selectName + '_month';
    var dateSelectName = selectName + '_date';
    document.writeln(  makeMonthSelect( monthSelectName) +'월 '+makeDateSelect( dateSelectName) +'일 ');
}
...
function printYearToMonthSelect( yearSelectName, monthSelectName ) {
    document.writeln( makeYearSelect( yearSelectName ) + '년 '+makeMonthSelect( monthSelectName) +'월 ' );
}
...
function printHourToMinuteSelect(selectName) {
    ...
    var hourSelectName = selectName + '_hour';
    var minuteSelectName = selectName + '_minute';
    document.writeln(makeHourSelect( hourSelectName) +'시 '+makeMinuteSelect( minuteSelectName) +'분 ');
}
...
function makeMonthSelect( monthSelectName ) {
    ...
    for ( var i = 1; i <= 12; i++ )
    html    +=  '<option value="' + ( ( i < 10 ) ? '' + i : i) + '"'+((now.getMonth()+ 1 ==i)?' selected' : '')+'>'+i+'</option>\n';
    html += '</select>';
    return html;
    } else {
...
function makeDateSelect( dateSelectName ) {
    ...
    for ( var i = 1; i <= 31; i++ )
    html    +=  '<option value="' + ( ( i < 10 ) ? '' + i : i) + '"'+((now.getDate() ==i)?' selected' : '')+'>'+i+'</option>';
    html += '</select>';
    return html;
    } else {
...
function makeHourSelect( hourSelectName ) {
    ...
    for ( var i = 0; i <= 23; i++ )
    html    +=  '<option value="' + ( ( i < 10 ) ? '' + i : i) + '"'+((now.getHours() == i ) ? ' selected' : '')+'>'+i+'</option>';
    html += '</select>';
...
function makeMinuteSelect( minuteSelectName ) {
    ...
    for ( var i = 0; i <= 59; i++ )
    html    +=  '<option value="' + ( ( i < 10 ) ? '' + i : i) + '"'+((now.getMinutes()==i)?' selected' : '')+'>'+i+'</option>';
    html += '</select>';
    return html;
    } else {
...
function makeSecondSelect( secondSelectName ) {
    ...
    for ( var i = 0; i <= 59; i++ )
    html    +=  '<option value="' + ( ( i < 10 ) ? '' + i : i) + '"'+((now.getSeconds()==i)?' selected' : '')+'>'+i+'</option>';
    html += '</select>';
    return html;
    } else {
...
function getCheckedAllValue(objForm, strObj,return_var){
  var len = objForm.elements.length;
  for ( var i = 0; i < len; i++ ){
    if(objForm.elements[i].name == strObj){
      if(objForm.elements[i].checked){
      	return_var.push(objForm.elements[i].value);
      }
    }
  }
  return return_var;
...
function kebiSetCookie(name,value,expires){
  var str = ""+name+"="+escape(value);
  var exdata = "";
  if(expires != ""){
    exdata = ";expires="+expires.toGMTString();
...
//input Text Box
function setTextByValue( checkObject, value ) {

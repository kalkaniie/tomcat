...
function chmod(value){
  if(value == 'P'){
    ...
    document.all['job'].innerHTML="&nbsp; <img src=../image/kor/loginpage/bullet_00.gif align=absmiddle> 직업";
    S_JOB.style.display="inline";
    S_CLASS.style.display="none";
  }else{
    document.all['comp'].innerHTML="&nbsp; <font color=#FF0000>*</font> 회사명";
    document.all['job'].innerHTML="&nbsp; <img src=../image/kor/loginpage/bullet_00.gif align=absmiddle> 업종";
